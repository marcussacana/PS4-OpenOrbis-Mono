...
namespace SixLabors.ImageSharp.Formats.Webp.Lossy
{
    ...
    internal class Vp8ModeScore
    {
        ...
        public void Clear()
        {
            Array.Clear(this.YDcLevels, 0, YDcLevels.Length);
            Array.Clear(this.YAcLevels, 0, YAcLevels.Length);
            Array.Clear(this.UvLevels, 0, UvLevels.Length);
            Array.Clear(this.ModesI4, 0, ModesI4.Length);
            Array.Clear(this.Derr, 0, Derr.Length);
        }
