...
namespace SDL2
{
	public static class SDL_mixer
	{
		...
		public static extern IntPtr INTERNAL_MIX_Linked_Version();
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		public static extern IntPtr INTERNAL_Mix_LoadMUS(
			byte[] file
		);
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		public static extern IntPtr INTERNAL_Mix_GetChunkDecoder(int index);
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		public static extern IntPtr INTERNAL_Mix_GetMusicDecoder(int index);
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		public static extern int INTERNAL_Mix_SetMusicCMD(
			byte[] command
		);
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		public static extern int INTERNAL_Mix_SetSoundFonts(
			byte[] paths
		);
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		public static extern IntPtr INTERNAL_Mix_GetSoundFonts();
